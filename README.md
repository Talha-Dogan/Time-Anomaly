...
Travel through shifting timelines, face enemies from different ages, solve environmental puzzles, and fight using anything from Stone Age tools to high-tech gear. Every decision you make influences future worlds and shapes the chaos ahead.
...
This game uses the following third-party assets. Huge thanks to the creators for sharing their work!

### 🎨 3D Models & Environments

* **T-Rex** by Quaternius - [Poly Pizza](https://poly.pizza/m/UYtneO5FpF)
* **Business Man** by Quaternius - [Poly Pizza](https://poly.pizza/m/JFrLIKqvCH)
* **Trees** by Creative Mango - [Sketchfab](https://skfb.ly/LYW9) (Licensed under [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/))
* **Mushroom Creature** by len.rocketdan - [Sketchfab](https://skfb.ly/oHBx7) (Licensed under [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/))
* **HourGlass Low Poly** by SkyFightUltra - [Sketchfab](https://skfb.ly/owXPJ) (Licensed under [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/))
